...
A command-line utility, [cuidgen](https://github.com/xaevik/cuidgen/), is also available that implements the cuid.net library for those wishing to leverage CUIDs in scripting environments.
